...
const  displayPokemon = (pokemon) => {
    ...
    const displayPokemonImage = document.createElement('img');
    displayPokemonImage.src = pokemon.sprites.front_default;
    pokemonDisplay.appendChild(displayPokemonImage);
}
